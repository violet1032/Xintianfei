...
public class GambleSimpleHistory implements Serializable {
    ...
    public GambleSimpleHistory parse(String str) throws JSONException {
        ...
        setMoney(new BigDecimal(jsonUtils.getString("money")).divide(new BigDecimal(100)));
        ...
        setWin(new BigDecimal(jsonUtils.getString("win")).divide(new BigDecimal(100)));
        ...
        if (getStatus() == E_STATUE_TYPE.none.value)
            ...
            result = E_RESULT_TYPE.getIndex(getResult()).name;
        setStrResult(result);
        return this;
    }
