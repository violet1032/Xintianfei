    ...
    public static boolean deleteDirectory(File file) {
        ...
        if (!file.getPath().equals("")) {
            ...
            if (file.isDirectory()) {
                ...
                try {
                    for (int i = 0; i < listfile.length; i++) {
                        File deletedFile = new File(file.toString() + "/"
                                + listfile[i].toString());
                        deletedFile.delete();
                    }
                    file.delete();
...
//            return size + "Byte";
    ...
    public static void downLoadFromUrl(String urlStr, String fileName, String savePath) throws IOException {
        ...
        Log.e("FileUtils", "info:" + url + " download success");
    }

    public static void downLoadFileFromUrl(String ourputFile, String urlStr) throws IOException {
        File file = new File(ourputFile);
        Log.e("FileUtils", "file.exists()：：：" + file.exists());
        if (!file.exists()) {
            file.createNewFile();
        }
